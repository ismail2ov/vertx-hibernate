package co.kukalabs.sandbox.hibernate.app;

import co.kukalabs.sandbox.hibernate.web.WebVerticle;
...
import co.kukalabs.sandbox.hibernate.data.ProjectRepositoryImpl;
import co.kukalabs.sandbox.hibernate.model.Project;
import co.kukalabs.sandbox.hibernate.model.Task;
import co.kukalabs.sandbox.hibernate.service.SimpleProjectService;
import co.kukalabs.sandbox.hibernate.service.SimpleProjectServiceImpl;
